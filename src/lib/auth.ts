...
export const authOptions: NextAuthOptions = {
  providers: [
    GoogleProvider({
      ...
      allowDangerousEmailAccountLinking: true, // Autorise la fusion si l'email est identique
    }),
    CredentialsProvider({
      name: "Credentials",
      credentials: {
  ...
  pages: {
    ...
    secret: process.env.NEXTAUTH_SECRET || "fallback-secret-for-build-purposes",
  };
